(function () {
  ...
  function updateLoadingDisplay() {
    ...
    const lines = [
      ...
      '<a href="https://docs.google.com/document/d/1baSNjc2NsNII6bfuW-hWQX_JoapRp8_djr2fYlLDXjQ/edit?tab=t.mzrcu7vup4qe" style="font-size: 15px; color: #14b4f3; text-decoration: underline; margin-bottom: 10px; display: block;">ecog</a>',
    ];
